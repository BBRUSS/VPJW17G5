...
public:
    ...
    {
        CameraContrast->setWindowTitle(QApplication::translate("CameraContrast", "Calibration", Q_NULLPTR));
        pushButtonStartCam->setText(QApplication::translate("CameraContrast", "Start Camera", Q_NULLPTR));
        pushButtonStopCam->setText(QApplication::translate("CameraContrast", "Stop Camera", Q_NULLPTR));
        pushButtonSaveContrast->setText(QApplication::translate("CameraContrast", "Save", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("CameraContrast", "Black/White Threshold", Q_NULLPTR));
        lineEdit_2->setText(QApplication::translate("CameraContrast", "Max-Value", Q_NULLPTR));
        labelImageContrast->setText(QString());
        labelImageOrig->setText(QString());
        lineEdit_3->setText(QApplication::translate("CameraContrast", "Camera ID:", Q_NULLPTR));
        pushButtonGetIntrinsics->setText(QApplication::translate("CameraContrast", "get Intrinsics", Q_NULLPTR));
        pushButtonGetExtrinsics->setText(QApplication::translate("CameraContrast", "get Extrinsics", Q_NULLPTR));
        pushButtonResetThr->setText(QApplication::translate("CameraContrast", "Reset", Q_NULLPTR));
        pushButtonCloseCalibWindow->setText(QApplication::translate("CameraContrast", "Close", Q_NULLPTR));
    } // retranslateUi
