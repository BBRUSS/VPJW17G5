...
public:
    ...
    void setupUi(QMainWindow *RobotDetectionMainWindow)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 201, 700));
        ...
        labelImageContrast = new QLabel(tabMain_Calibration);
        ...
        sizePolicy16.setHeightForWidth(labelImageContrast->sizePolicy().hasHeightForWidth());
        labelImageContrast->setSizePolicy(sizePolicy16);

        horizontalLayout_2->addWidget(labelImageContrast);

        labelImageOrig = new QLabel(tabMain_Calibration);
        labelImageOrig->setObjectName(QStringLiteral("labelImageOrig"));
        sizePolicy16.setHeightForWidth(labelImageOrig->sizePolicy().hasHeightForWidth());
        labelImageOrig->setSizePolicy(sizePolicy16);

        horizontalLayout_2->addWidget(labelImageOrig);
        ...
        sizePolicy17.setHeightForWidth(horizontalSliderMaxValue->sizePolicy().hasHeightForWidth());
        horizontalSliderMaxValue->setSizePolicy(sizePolicy17);
        horizontalSliderMaxValue->setOrientation(Qt::Horizontal);

        gridLayout->addWidget(horizontalSliderMaxValue, 3, 5, 1, 1);

        labelBWThreshold = new QLabel(tabMain_Calibration);
        labelBWThreshold->setObjectName(QStringLiteral("labelBWThreshold"));
        sizePolicy5.setHeightForWidth(labelBWThreshold->sizePolicy().hasHeightForWidth());
        labelBWThreshold->setSizePolicy(sizePolicy5);
        labelBWThreshold->setAlignment(Qt::AlignCenter);

        gridLayout->addWidget(labelBWThreshold, 2, 4, 1, 1);

        lineEditStatus = new QLineEdit(tabMain_Calibration);
        lineEditStatus->setObjectName(QStringLiteral("lineEditStatus"));
        sizePolicy11.setHeightForWidth(lineEditStatus->sizePolicy().hasHeightForWidth());
        lineEditStatus->setSizePolicy(sizePolicy11);
        lineEditStatus->setMaximumSize(QSize(16777215, 16777215));
        lineEditStatus->setBaseSize(QSize(0, 0));
        ...
        sizePolicy5.setHeightForWidth(pushButtonResetThr->sizePolicy().hasHeightForWidth());
        pushButtonResetThr->setSizePolicy(sizePolicy5);
        ...
        sizePolicy17.setHeightForWidth(horizontalSliderThreshold->sizePolicy().hasHeightForWidth());
        horizontalSliderThreshold->setSizePolicy(sizePolicy17);
        horizontalSliderThreshold->setOrientation(Qt::Horizontal);

        gridLayout->addWidget(horizontalSliderThreshold, 3, 4, 1, 1);

        pushButtonStartCam = new QPushButton(tabMain_Calibration);
        pushButtonStartCam->setObjectName(QStringLiteral("pushButtonStartCam"));
        sizePolicy11.setHeightForWidth(pushButtonStartCam->sizePolicy().hasHeightForWidth());
        pushButtonStartCam->setSizePolicy(sizePolicy11);
        ...
        sizePolicy11.setHeightForWidth(pushButtonGetExtrinsics->sizePolicy().hasHeightForWidth());
        pushButtonGetExtrinsics->setSizePolicy(sizePolicy11);
        ...
        sizePolicy11.setHeightForWidth(labelCamID->sizePolicy().hasHeightForWidth());
        labelCamID->setSizePolicy(sizePolicy11);
        ...
        sizePolicy5.setHeightForWidth(labelMaxValue->sizePolicy().hasHeightForWidth());
        labelMaxValue->setSizePolicy(sizePolicy5);
        labelMaxValue->setAlignment(Qt::AlignCenter);

        gridLayout->addWidget(labelMaxValue, 2, 5, 1, 1);
        ...
        sizePolicy11.setHeightForWidth(pushButtonStopCam->sizePolicy().hasHeightForWidth());
        pushButtonStopCam->setSizePolicy(sizePolicy11);
        ...
        sizePolicy5.setHeightForWidth(pushButtonSaveContrast->sizePolicy().hasHeightForWidth());
        pushButtonSaveContrast->setSizePolicy(sizePolicy5);

        gridLayout->addWidget(pushButtonSaveContrast, 2, 2, 1, 1);

        pushButtonGetIntrinsics = new QPushButton(tabMain_Calibration);
        pushButtonGetIntrinsics->setObjectName(QStringLiteral("pushButtonGetIntrinsics"));
        sizePolicy11.setHeightForWidth(pushButtonGetIntrinsics->sizePolicy().hasHeightForWidth());
        pushButtonGetIntrinsics->setSizePolicy(sizePolicy11);

        gridLayout->addWidget(pushButtonGetIntrinsics, 3, 0, 1, 1);
        ...
        QSizePolicy sizePolicy18(QSizePolicy::Maximum, QSizePolicy::Fixed);
        sizePolicy18.setHorizontalStretch(0);
        sizePolicy18.setVerticalStretch(0);
        sizePolicy18.setHeightForWidth(spinBoxSwap1->sizePolicy().hasHeightForWidth());
        spinBoxSwap1->setSizePolicy(sizePolicy18);
        ...
        sizePolicy18.setHeightForWidth(pushButtonSwap->sizePolicy().hasHeightForWidth());
        pushButtonSwap->setSizePolicy(sizePolicy18);
        ...
        sizePolicy18.setHeightForWidth(spinBoxSwap2->sizePolicy().hasHeightForWidth());
        spinBoxSwap2->setSizePolicy(sizePolicy18);
        ...
        sizePolicy18.setHeightForWidth(spinBoxFieldHeight->sizePolicy().hasHeightForWidth());
        spinBoxFieldHeight->setSizePolicy(sizePolicy18);
        ...
        sizePolicy18.setHeightForWidth(spinBoxFieldWidth->sizePolicy().hasHeightForWidth());
        spinBoxFieldWidth->setSizePolicy(sizePolicy18);
        ...
        sizePolicy18.setHeightForWidth(pushButtonResizeCamField->sizePolicy().hasHeightForWidth());
        pushButtonResizeCamField->setSizePolicy(sizePolicy18);
        ...
        sizePolicy18.setHeightForWidth(pushButtonSaveSettings->sizePolicy().hasHeightForWidth());
        pushButtonSaveSettings->setSizePolicy(sizePolicy18);
        ...
        QSizePolicy sizePolicy19(QSizePolicy::Maximum, QSizePolicy::Minimum);
        sizePolicy19.setHorizontalStretch(0);
        sizePolicy19.setVerticalStretch(0);
        sizePolicy19.setHeightForWidth(scrollAreaSettings->sizePolicy().hasHeightForWidth());
        scrollAreaSettings->setSizePolicy(sizePolicy19);
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 412, 1161));
        ...
        sizePolicy20.setHeightForWidth(groupBoxFileSettings->sizePolicy().hasHeightForWidth());
        groupBoxFileSettings->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(labelSettingsFileName->sizePolicy().hasHeightForWidth());
        labelSettingsFileName->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(groupBoxUdpSettings->sizePolicy().hasHeightForWidth());
        groupBoxUdpSettings->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(labelSendToIp->sizePolicy().hasHeightForWidth());
        labelSendToIp->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(labelSendToPort->sizePolicy().hasHeightForWidth());
        labelSendToPort->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(labelSendToIpSyncService->sizePolicy().hasHeightForWidth());
        labelSendToIpSyncService->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(labelSendToPortSyncService->sizePolicy().hasHeightForWidth());
        labelSendToPortSyncService->setSizePolicy(sizePolicy20);
        ...
        sizePolicy10.setHeightForWidth(lineEditSendToPortSyncService->sizePolicy().hasHeightForWidth());
        lineEditSendToPortSyncService->setSizePolicy(sizePolicy10);
        ...
        sizePolicy20.setHeightForWidth(labelReceiveIpSyncService->sizePolicy().hasHeightForWidth());
        labelReceiveIpSyncService->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(labelReceivePortSyncService->sizePolicy().hasHeightForWidth());
        labelReceivePortSyncService->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(labelNumberOfCams->sizePolicy().hasHeightForWidth());
        labelNumberOfCams->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(labelCameraImageWidth->sizePolicy().hasHeightForWidth());
        labelCameraImageWidth->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(labelCameraImageHeight->sizePolicy().hasHeightForWidth());
        labelCameraImageHeight->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(labelCameraFieldWidth->sizePolicy().hasHeightForWidth());
        labelCameraFieldWidth->setSizePolicy(sizePolicy20);
        ...
        sizePolicy20.setHeightForWidth(labelCameraFieldHeight->sizePolicy().hasHeightForWidth());
        labelCameraFieldHeight->setSizePolicy(sizePolicy20);
    ...
    void retranslateUi(QMainWindow *RobotDetectionMainWindow)
    {
        ...
        pushButtonSaveContrast->setText(QApplication::translate("RobotDetectionMainWindow", "Save", Q_NULLPTR));
        pushButtonGetIntrinsics->setText(QApplication::translate("RobotDetectionMainWindow", "get Intrinsics", Q_NULLPTR));
        ...
        labelRobotStdThresh->setText(QApplication::translate("RobotDetectionMainWindow", "Robot Position Standard Deviation Threshold (Divider of Radius)", Q_NULLPTR));
        labelRobotStdThreshMax->setText(QApplication::translate("RobotDetectionMainWindow", "Robot Position Standard Deviation Max (Factor of Deviation Thresh)", Q_NULLPTR));
